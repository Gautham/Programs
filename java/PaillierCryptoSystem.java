...
public class PaillierCryptoSystem {
	...
	public String Encrypt(String M) {
		int len = M.length();
		String C = "";
		java.text.NumberFormat nf = new java.text.DecimalFormat("00000000000000000000000000");
		for (int i = 0; i < len; i++) {
	...
	public String Decrypt(String C) {
		...
		String M = "";
		for (int i = 0; i < len; i++) {
			String Temp = C.substring(i * 26, i * 26 + 26);
	...
	public static void main (String args[]) {
		...
		String C = P.Encrypt(M);
		out.println(C);
		out.println(P.Decrypt(C));
	}
}
